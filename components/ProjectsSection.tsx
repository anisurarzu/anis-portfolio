...
const technologyIconMap: Record<string, ComponentType<{ size: string }>> = {
  ...
  Prisma: DevIcons.PrismaOriginal,
...
const projects: Project[] = [
  {
    ...
    category: "SaaS",
    description:
      "A calm productivity platform for personal focus — plus campus tools for schools covering students, classes, attendance, and fees.",
    duration: "2025 – Present",
    impact: "Personal + institute product",
    achievements: [
      "Designed and shipped a full SaaS product covering tasks, calendar, goals, habits, focus timers, and analytics in one workspace.",
      "Built campus mode for schools with student records, staff, classes, attendance, announcements, and fee management modules.",
      "Created marketing landing, sandbox demos, and organization pricing flows so teams can try personal or institute experiences instantly.",
      "Delivered a clean, modern product UI with dashboard overview, task boards, month calendar, and distraction-free focus sessions.",
    ],
    technologies: [
      "Next.js",
      "TypeScript",
    ...
    link: "https://www.usetaskivo.com/",
    isLive: true,
    images: [
      "/images/taskivo-1.jpg",
      "/images/taskivo-2.png",
      "/images/taskivo-3.png",
      "/images/taskivo-4.jpg",
      "/images/taskivo-5.png",
      "/images/taskivo-6.png",
      "/images/taskivo-7.png",
      "/images/taskivo-8.png",
      "/images/taskivo-9.png",
      "/images/taskivo-10.png",
      "/images/taskivo-11.png",
      "/images/taskivo-12.png",
      "/images/taskivo-13.png",
      "/images/taskivo-14.png",
      "/images/taskivo-15.png",
      "/images/taskivo-16.png",
      "/images/taskivo-17.jpg",
      "/images/taskivo-18.png",
    ],
  },
  {
    title: "ROOTORA",
    category: "E-commerce",
    description:
      "A live Bangladeshi e-commerce brand for honey, sweets, fashion, and artisan goods — with admin ops, AI support, and Pathao courier fulfillment.",
    duration: "2025 – Present",
    impact: "Live store · Pathao courier",
    achievements: [
      "Shipped a full storefront with smart search, collections, flash sales, product detail pages, cart/checkout, and order tracking.",
      "Built a ROOTORA Admin dashboard for revenue, orders, customers, catalog health, inventory alerts, and sales analytics.",
      "Integrated Pathao courier from the orders desk so fulfilled packages can be booked and managed directly from admin.",
      "Added multi-channel order support (Website, Facebook, Instagram, WhatsApp) plus AI chat that tracks live orders by RT- number.",
    ],
    technologies: [
      "Next.js",
      "TypeScript",
    ...
    link: "https://shoprootora.com/",
    isLive: true,
    images: [
      "/images/rootora-1.jpg",
      "/images/rootora-2.jpg",
      "/images/rootora-3.jpg",
      "/images/rootora-4.jpg",
      "/images/rootora-5.jpg",
      "/images/rootora-6.png",
      "/images/rootora-7.png",
      "/images/rootora-8.png",
      "/images/rootora-9.jpg",
    ],
  },
  {
    ...
    description:
      "Live hotel operations system for Cox's Bazar — bookings, room calendar, daily cash desk, expenses, reports, and role-based staff access.",
    duration: "2025 – Present",
    impact: "Live PMS · Cox's Bazar",
    achievements: [
      "Built a full hotel management console with dashboard KPIs for bookings, check-ins, occupancy, and revenue.",
      "Shipped an interactive booking calendar by room/date plus a create-booking flow for guest details, stays, and payments.",
      "Added daily statement and expense modules for cash desk collections, dues tracking, and PDF downloads.",
      "Implemented hotel info, room categories/pricing, and RBAC settings so staff roles can control view/add/edit/delete per page.",
    ],
    technologies: [
      "Next.js",
      "TypeScript",
    ...
    link: "https://hotelseashorebd.com/",
    isLive: true,
    images: [
      "/images/seashore-1.jpg",
      "/images/seashore-2.png",
      "/images/seashore-3.png",
      "/images/seashore-4.png",
      "/images/seashore-5.png",
      "/images/seashore-6.png",
      "/images/seashore-7.png",
      "/images/seashore-8.png",
    ],
  },
  {
    title: "EBS-365 ERP",
